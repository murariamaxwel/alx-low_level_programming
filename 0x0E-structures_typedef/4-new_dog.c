...
/**
 * len - compute a string's length
 * @str: string under scrutiny
 ...
 * plus the terminating byte
 * to the buffer pointed to by dest
 * @dest: copy source to this buffer
 * @src: this is the source to be cpied
...
/**
 * new_dog - instantiates an new instance
...
dog_t *new_dog(char *name, float age, char *owner)
{
	...
	/* make copies of struct members and validates, else beome free on error */
