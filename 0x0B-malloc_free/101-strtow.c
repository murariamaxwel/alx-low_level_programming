...
/**
 * word_count - Count number of words (space separation)
...
/**
 * find_words_len - Find len of words in string
 * @str: string under scrutiny
 * @words: represents the word count
 *
 * Return: word count
 */
...
/**
 * strtow - Split a string into indidual words
 * @str: String to split
 *
